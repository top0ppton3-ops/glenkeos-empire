...
var V = (e2 = {}, t2 = k) => {
  let [o2, s2] = te(f2[t2] || j), a2 = oe(f2[t2]);
  ee(() => (a2.current !== f2[t2] && s2(f2[t2]), v.push([t2, s2]), () => {
...
var w2 = (e2, t2 = "default") => {
  let { toasts: o2, pausedAt: s2 } = V(e2, t2), a2 = ne(/* @__PURE__ */ new Map()).current, i2 = A((c2, m2 = ce) => {
    if (a2.has(c2)) return;
    let p2 = setTimeout(() => {
